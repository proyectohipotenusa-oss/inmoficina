              ...
              <>
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-white/40 uppercase tracking-widest">Crear Ticket Rápido</p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSupportSubmit} className="space-y-5">
                  <div>
                    ...
                    <select required className="w-full bg-ink-950 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:border-brand-500 outline-none transition-all cursor-pointer"
                  ...
                  <div>
                    ...
                    <textarea required rows={5} className="w-full bg-ink-950 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:border-brand-500 outline-none transition-all resize-none leading-relaxed" 
