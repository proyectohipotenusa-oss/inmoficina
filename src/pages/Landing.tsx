...
export default function Landing() {
  ...
  const FAQS = [
    ...
    { q: "¿Qué impacto tiene el diseño inmersivo en mis ventas?", a: "Nuestras fichas VIP y dossiers retienen al cliente un 300% más de tiempo que un PDF estático." },
    { q: "¿Qué es exactamente el Dossier de Inversión?", a: "Es un reporte automático que calcula el ROI, Cash Flow y Yield Neto para inversores." },
    { q: "¿Puedo gestionar a mi equipo de agentes en el CRM?", a: "Por supuesto. El Plan Premium incluye 3 licencias para que tú y tu equipo trabajéis sobre la misma base de datos." },
    { q: "¿Realmente cerraré más ventas con Inmoficina?", a: "Sí. No somos un archivador de propiedades, somos una herramienta de persuasión." },
    { q: "¿Hay permanencia?", a: "No. Gánamos tu confianza mes a mes. Cancelas cuando quieras con un clic." },
    { q: "¿Están seguros mis datos?", a: "Cifrado de grado militar. Tu información es privada y exclusiva de tu agencia." }
  ];
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-white/50 text-xs font-light leading-relaxed mb-8">
              Si tienes dudas, requerimientos especiales o necesitas un tutorial de uso, contáctanos.
            </p>
