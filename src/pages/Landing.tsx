...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-ink-950 text-white font-sans selection:bg-brand-500/30 overflow-x-hidden scroll-smooth w-full">
      ...
      <section className="relative pt-32 pb-16 px-4 sm:px-6 lg:pt-40 lg:pb-24 text-center w-full">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          Tu agencia, a toda marcha.<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-300 via-brand-400 to-emerald-400 font-extrabold">Más ventas. Menos caos.</span>
          </h1>
          <p className="text-sm sm:text-base text-white/50 max-w-xl mx-auto mb-10 leading-relaxed font-light tracking-wide px-4">
          ...
          <div className="flex flex-col items-center gap-5 px-4">
            <button onClick={() => setIsModalOpen(true)} className="w-full sm:w-auto group relative px-6 py-3 bg-white text-ink-950 rounded-lg font-bold uppercase tracking-widest text-[11px] hover:bg-brand-50 hover:scale-[1.02] transition-all shadow-[0_10px_30px_rgba(255,255,255,0.1)] active:scale-95 flex items-center justify-center gap-2">
              Solicitar Prueba Gratuita <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" />
            </button>
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6 opacity-40 grayscale pointer-events-none">
      ...
      <section id="experiencia" className="py-16 sm:py-20 px-4 sm:px-6 bg-gradient-to-b from-white/[0.02] to-transparent border-y border-white/5 w-full">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 items-center">
          <div className="order-2 lg:order-1">
             <div className="relative group">
                ...
                <div className="relative aspect-[4/5] rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-ink-900">
                  <img src={HERO_IMG_URL} alt="Oficina Premium Real Estate" className="w-full h-full object-cover scale-[1.03] group-hover:scale-100 transition-transform duration-1000 grayscale-[0.2] group-hover:grayscale-0" />
                  ...
                  <div className="absolute bottom-4 sm:bottom-6 left-4 right-4 sm:left-6 sm:right-6">
                     <div className="p-4 bg-white/[0.03] backdrop-blur-xl rounded-xl border border-white/10 flex items-center gap-3">
                        <div className="w-8 h-8 bg-brand-500/20 rounded-md flex items-center justify-center border border-brand-500/30 shrink-0"><Smartphone size={16} className="text-brand-300" /></div>
                        <div><p className="text-[8px] font-bold text-brand-400 uppercase tracking-[0.2em] mb-0.5">Tecnología Móvil</p><p className="text-xs font-medium text-white/90">Tu agencia centralizada y en tu bolsillo.</p></div>
                     </div>
                  </div>
                </div>
             </div>
          ...
          <div className="order-1 lg:order-2 space-y-8 sm:space-y-10">
            <h2 className="text-2xl md:text-3xl font-bold leading-[1.2] tracking-tight">La marca <br/><span className="text-white/40 font-light italic">es el mensaje.</span></h2>
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="group flex gap-4">
                  <div className="w-8 h-8 rounded-md bg-white/[0.03] border border-white/10 flex items-center justify-center shrink-0 group-hover:border-brand-500/30 group-hover:bg-brand-500/10 transition-all"><item.icon className="text-brand-400 group-hover:scale-110 transition-transform" size={16} /></div>
                  <div><h4 className="text-xs font-semibold mb-1">{item.title}</h4><p className="text-white/50 text-xs font-light leading-relaxed">{item.desc}</p></div>
                </div>
              ))}
            </div>
      ...
      <section id="arsenal" className="py-16 sm:py-20 px-4 sm:px-6 w-full">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
          {[
            ...
            <div key={i} className="group p-5 sm:p-6 rounded-xl bg-white/[0.02] border border-white/5 hover:border-brand-500/20 transition-all duration-300">
      ...
      <section id="tarifa" className="py-16 sm:py-20 px-4 sm:px-6 relative w-full">
        <div className="max-w-2xl mx-auto bg-gradient-to-br from-ink-900 to-ink-950 border border-white/10 p-6 sm:p-8 md:p-12 rounded-[2rem] text-center shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 px-4 py-1 bg-brand-500 text-[9px] font-bold uppercase tracking-widest rounded-b-md shadow-lg shadow-brand-500/20">Pack Agencia Premium</div>
          <div className="mb-6 sm:mb-8 pt-4 sm:pt-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3 text-left mb-8 sm:mb-10 border-t border-white/5 pt-6 sm:pt-8">
            {[ "Licencia para 3 usuarios", "Fichas VIP Ilimitadas", "Informes CMA Ilimitados", "Multipublicación Portales", "Dossiers de Inversión Pro", "IA de Redacción Integrada", "Catálogo Público Digital", "Pipeline y Gestión de Leads", "Códigos QR Dinámicos", "Compresión Fotos en la Nube" ].map((item, i) => (
              <div key={i} className="flex items-center gap-2.5 text-white/60 font-light text-xs"><CheckCircle2 className="text-brand-400 shrink-0" size={14} /> {item}</div>
            ))}
          </div>
          <button onClick={() => setIsModalOpen(true)} className="w-full py-3.5 rounded-lg bg-brand-600 text-white font-semibold text-xs uppercase tracking-widest hover:bg-brand-500 transition-all shadow-lg shadow-brand-500/20">Comenzar 14 días gratis</button>
        </div>
      </section>

      <footer className="py-10 sm:py-12 px-4 sm:px-6 border-t border-white/5 text-center bg-ink-950/50 w-full">
        <div className="max-w-6xl mx-auto flex flex-col items-center">
          ...
          <p className="text-[9px] font-semibold uppercase tracking-[0.3em] text-white/20 mb-6 text-center">Elevando el estándar inmobiliario</p>
          <div className="flex flex-row justify-center items-center gap-4 sm:gap-8 text-[8px] text-white/30 uppercase font-medium mt-1 mb-4 flex-wrap">
            ...
            <a href={TEMPORARY_LEGAL_URL} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Privacidad</a>
          ...
          <p className="text-[8px] font-light text-white/10 uppercase tracking-widest pt-4 border-t border-white/5 w-full text-center">© {new Date().getFullYear()} Inmoficina. Todos los derechos reservados.</p>
        </div>
      </footer>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade-in overflow-y-auto">
          ...
          <div className="relative w-full max-w-sm bg-ink-950 border border-white/10 rounded-2xl shadow-2xl overflow-hidden animate-slide-up my-auto">
            <div className="p-6 sm:p-8">
              <button onClick={() => setIsModalOpen(false)} className="absolute top-4 right-4 text-white/30 hover:text-white transition"><X size={20} /></button>
              {formStatus === 'success' ? (
                <div className="text-center py-4 animate-fade-in">
                  <div className="w-12 h-12 bg-emerald-500/10 rounded-xl flex items-center justify-center mx-auto mb-4 border border-emerald-500/20"><Send size={24} className="text-emerald-400" /></div>
                ...
                <>
                  <div className="mb-6 text-center">
                    <h3 className="text-lg sm:text-xl font-bold text-white mb-1">Solicitud de Acceso</h3>
                    <p className="text-[9px] sm:text-[10px] text-brand-400 uppercase tracking-widest font-semibold">14 Días Gratis • Pack Agencia Premium</p>
                  </div>
                  <form onSubmit={handleSubmit} className="space-y-3">
                    <div className="space-y-1"><label className="text-[9px] font-semibold text-white/40 uppercase tracking-widest ml-1">Inmobiliaria *</label><input required className="w-full bg-ink-900 border border-white/10 rounded-lg px-3 py-2.5 text-xs text-white focus:border-brand-500 transition-all font-light" value={formData.nombre_agencia} onChange={e => setFormData({...formData, nombre_agencia: e.target.value})} /></div>
                    <div className="space-y-1"><label className="text-[9px] font-semibold text-white/40 uppercase tracking-widest ml-1">Dirección *</label><input required className="w-full bg-ink-900 border border-white/10 rounded-lg px-3 py-2.5 text-xs text-white focus:border-brand-500 transition-all font-light" value={formData.direccion} onChange={e => setFormData({...formData, direccion: e.target.value})} /></div>
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1"><label className="text-[9px] font-semibold text-white/40 uppercase tracking-widest ml-1">Ciudad *</label><input required className="w-full bg-ink-900 border border-white/10 rounded-lg px-3 py-2.5 text-xs text-white focus:border-brand-500 transition-all font-light" value={formData.ciudad} onChange={e => setFormData({...formData, ciudad: e.target.value})} /></div>
                      <div className="space-y-1"><label className="text-[9px] font-semibold text-white/40 uppercase tracking-widest ml-1">C.P. *</label><input required className="w-full bg-ink-900 border border-white/10 rounded-lg px-3 py-2.5 text-xs text-white focus:border-brand-500 transition-all font-light" value={formData.codigo_postal} onChange={e => setFormData({...formData, codigo_postal: e.target.value})} /></div>
                    </div>
                    <div className="space-y-1"><label className="text-[9px] font-semibold text-white/40 uppercase tracking-widest ml-1">Responsable *</label><input required className="w-full bg-ink-900 border border-white/10 rounded-lg px-3 py-2.5 text-xs text-white focus:border-brand-500 transition-all font-light" value={formData.contacto_nombre} onChange={e => setFormData({...formData, contacto_nombre: e.target.value})} /></div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="space-y-1"><label className="text-[9px] font-semibold text-white/40 uppercase tracking-widest ml-1">Teléfono *</label><input required type="tel" className="w-full bg-ink-900 border border-white/10 rounded-lg px-3 py-2.5 text-xs text-white focus:border-brand-500 transition-all font-light" value={formData.telefono} onChange={e => setFormData({...formData, telefono: e.target.value})} /></div>
                      <div className="space-y-1"><label className="text-[9px] font-semibold text-white/40 uppercase tracking-widest ml-1">Email *</label><input required type="email" className="w-full bg-ink-900 border border-white/10 rounded-lg px-3 py-2.5 text-xs text-white focus:border-brand-500 transition-all font-light" value={formData.email} onChange={e => setFormData({...formData, email: e.target.value})} /></div>
                    </div>
